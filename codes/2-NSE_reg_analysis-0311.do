...
reghdfe cit_r1 cong1 negative_cong1 negative industryKL lcf hightech small transition minority export rd asset0 logL if(ind~= 0 & profit_total_check >0),absorb(year ind district firmtypexz1) cluster(cic4)
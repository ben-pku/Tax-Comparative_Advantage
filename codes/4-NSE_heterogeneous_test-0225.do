...
areg cit_r1 congr1 lcf hightech small transition minority export rd  i.firmtypexz i.district  i.year if (ind~= 0 & profit_total_check >0 & (ind ~=3 )),absorb(ind) vce(robust) //-0.84
forvalues i =1(1)10{

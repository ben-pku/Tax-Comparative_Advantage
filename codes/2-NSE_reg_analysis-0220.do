...
*******************************************************************
******************* NSE  regression *******************************
*k的衡量：资产年初数，资产年末数 asset0 asset1
*l的衡量：雇佣人数 
...
foreach lb of varlist cong1 cong2 cong3 cong4 congr1 congr2 congr3 congr4 l_cong1 l_cong2 l_cong3 l_cong4 l_congr1 l_congr2 l_congr3 l_congr4{
	winsor2 `lb' ,  replace cut(0.5 99.5)
}
...
*****edited 0222***************************
	...
	areg cit_r1 l_cong1 i.firmtypexz  i.district  lcf hightech transition minority export rd asset0 i.year if (ind~= 0 & profit_total_check >0),absorb(cic4) vce(robust)
		areg cit_r1 l_cong1 i.firmtypexz  i.district  lcf hightech transition minority export rd asset0 i.year if (ind~= 0 & profit_total_check >0),absorb(ind) vce(robust)  //不太行

. hist l_cong1 if ( l_cong1>-0.2 & l_cong1<1 & ind~= 0 & profit_total_check >0), bin(100)
(bin=100, start=2.415e-07, width=.00997882)

. graph export "C:\Users\Benjamin Hwang\Documents\undergraduate_research-2021-Zhengwen_Liu\data-analysis\resul
> ts\2-NSE_reg_analysis-0218\l_cong1-distribution.eps", as(eps) name("Graph") preview(off)
(file C:\Users\Benjamin Hwang\Documents\undergraduate_research-2021-Zhengwen_Liu\data-analysis\results\2-NSE_r
> eg_analysis-0218\l_cong1-distribution.eps written in EPS format)

. hist l_congr1 if ( l_cong1>-0.2 & l_cong1<1 & ind~= 0 & profit_total_check >0), bin(100) graphregion(color(w
> hite))
(bin=100, start=-.98235291, width=.01980235)

. graph export "C:\Users\Benjamin Hwang\Documents\undergraduate_research-2021-Zhengwen_Liu\data-analysis\resul
> ts\2-NSE_reg_analysis-0218\l_congr1-distribution.eps", as(eps) name("Graph") preview(off)
